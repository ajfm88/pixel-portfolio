...
|---|---|---|---|
| D1 ⬜ | Link movement: 4-direction, 16×16 hitbox, tile collision, screen-edge detection | `Z_05.asm` (player logic) | Link walks, stops at walls, triggers screen change at edges |
